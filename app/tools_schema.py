Tools=[
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "Bucht einen Termin oder mehrere Termine in einem Rutsch. Code: 32 = schon verbucht",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "siteCd": {
                            ...
                            "positions": {
                                "type": "array",
                                "description": "Ein Array von Buchungspositionen. Jede Position entspricht einer Dienstleistung und enthält die folgenden Felder:",
                                "items": {
                                    "type": "object",
                                    "properties": {
                                        "ordinalPosition": {
                                        ...
                                        "employeeId": {
                                            "type": "integer",
                                            "description": "employeeId aus getEmployees."
                                        },
                                        "itemNo": {
                                            "type": "integer",
