...
async def get_whatsapp_connectivity_status(
    ...
    try:
        ...
        is_connected = bool(current_business.whatsapp_number and current_business.waba_status == WABAStatus.connected)
        ...
        if is_connected:
            ...
            elif current_business.waba_status == WABAStatus.pending:
                message = "WhatsApp Business API connection is pending."
            elif current_business.waba_status == WABAStatus.failed:
...
async def get_simple_whatsapp_status(
    ...
    try:
        # Determine status
        if current_business.whatsapp_number and current_business.waba_status == WABAStatus.connected:
            status = "connected"
        elif current_business.waba_status == WABAStatus.pending:
            status = "pending"
        elif current_business.waba_status == WABAStatus.failed:
